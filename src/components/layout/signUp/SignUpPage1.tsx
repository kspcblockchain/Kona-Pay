...
const SignUpPage1: React.FC = () => {
  ...
  const check1 = () => {
    setIsOpen1(false)
    setCheck({...check, service:true} )
  }

  const check2 = () => {
    setIsOpen2(false)
    setCheck({...check, personal:true} )
  }
  ...
  return (
    <IonApp>
      <IonPage>
            ...
            <div className="box-init box" style={{ height: "55%", flexDirection: "column" }}>
              ...
              >
                ...
                <IonItem style={{ display: "flex", width: "90%", marginBottom: "3%", marginRight: "5%" }}>
                  <IonCheckbox
                    checked={check.service && check.personal}
                ...
                <div style={{ display: "flex", width: "100%", justifyContent: "space-around" }}>
                  ...
                  <a style={{ fontSize: "14px", textAlign: "center", marginRight: "5%", alignSelf: "center" }} onClick={()=>{setIsOpen1(true)}}>
                    [상세보기]
                  </a>
                </div>
                ...
                <div style={{ display: "flex", width: "100%", justifyContent: "space-around" }}>
                  ...
                  <a style={{ fontSize: "14px", textAlign: "center", marginRight: "5%", alignSelf: "center" }} onClick={()=>{setIsOpen2(true)}}>
                    [상세보기]
                  </a>
                </div>
              </div>
        ...
        <IonModal isOpen={isOpen1}>
            <IonContent>
              <div style={{ display: "flex", justifyContent: "center", alignContent: "center", alignItems: "center", height: "80vh", flexDirection: "column", margin: "15% 0 0 0" }}>
                <textarea readOnly style={{width:"80%", height:"100%"}}>
                제1조(목적)
...
② "몰"의 승낙이 제12조 제1항의 수신확인통지 형태로 이용자에게 도달한 시점에 계약이 성립한 것으로 봅니다.
                ...
                <div style={{ width: "100%", display: "flex", justifyContent: "center", height: "8%" }}>
                  <IonButton style={{ width: "80%", height: "100%", fontSize: "130%" }} onClick={check1}>
                    확인
                  </IonButton>
                </div>
              </div>
...
② "몰"과 이용자간에 제기된 전자거래 소송에는 한국법을 적용합니다.
                ...
                <div style={{ width: "100%", display: "flex", justifyContent: "center", height: "8%" }}>
                  <IonButton style={{ width: "80%", height: "100%", fontSize: "130%" }} onClick={check2}>
                    확인
                  </IonButton>
                </div>
              </div>
